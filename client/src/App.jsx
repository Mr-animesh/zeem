    ...
    <main className="min-h-screen bg-slate-50 p-6">
      <div className="mx-auto max-w-5xl space-y-6">
        <header className="rounded-xl bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-sm text-slate-600">Minimal React + Tailwind demo UI for register and semantic matching.</p>
        </header>
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <form onSubmit={registerUser} className="space-y-3 rounded-xl bg-white p-5 shadow-sm">
            ...
            <textarea className="h-36 w-full rounded-md border px-3 py-2 font-mono text-xs" name="projectSummaryText" value={registerForm.projectSummaryText} onChange={onRegisterChange} />
          ...
          <form onSubmit={runMatch} className="space-y-3 rounded-xl bg-white p-5 shadow-sm">
            ...
            <textarea className="h-36 w-full rounded-md border px-3 py-2 text-sm" name="missionDescription" value={matchForm.missionDescription} onChange={onMatchChange} placeholder="Mission description for recruiter/admin query" required />
